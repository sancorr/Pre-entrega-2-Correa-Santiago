...
let ingreso = prompt ("busca tu celular por nombre")
function buscarCelular (arr,el){
  return arr.filter((el)=>{
    return el.celular.includes(ingreso)
  })
  return arr
}
let encontrado = buscarCelular(celulares,ingreso)
